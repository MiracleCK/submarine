...
const AP_Param::GroupInfo AP_RangeFinder_Params::var_info[] = {
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MIN_CM",  6, AP_RangeFinder_Params, min_distance_cm, 0),
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("MAX_CM",  7, AP_RangeFinder_Params, max_distance_cm, 1000),
    ...
    AP_GROUPINFO("RANGE", 56, AP_RangeFinder_Params, range, 10.0f),  //40.0f
