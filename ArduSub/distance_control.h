...
#define DISCONTROL_SPEED                        500.0f  // default horizontal speed in cm/s
#define DISCONTROL_SPEED_DOWN                  -150.0f  // default descent rate in cm/s
#define DISCONTROL_SPEED_UP                     250.0f  // default climb rate in cm/s

#define DISCONTROL_ACCEL_Z                      250.0f  // default vertical acceleration in cm/s/s.

#define DISCONTROL_LEASH_LENGTH_MIN             100.0f  // minimum leash lengths in cm
...
#define DISCONTROL_ACCEL_FILTER_HZ              2.0f    // low-pass filter on acceleration (unit: hz)
...
public:
    ...
    void relax_alt_hold_controllers(float distance);
